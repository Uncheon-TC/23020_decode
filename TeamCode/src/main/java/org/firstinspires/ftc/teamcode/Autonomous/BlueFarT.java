...
@Autonomous(name = "AutoBlueFarT 60s", group = "32020 AUTO")
public class BlueFarT extends OpMode {
    ...
    private static final Pose PARK_POSE =
            new Pose(37, 17, Math.toRadians(180));
