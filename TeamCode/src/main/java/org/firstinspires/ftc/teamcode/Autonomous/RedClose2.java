...
@Autonomous(name = "RedCloseEat3", group = "32020 AUTO")
public class RedClose2 extends OpMode {
    ...
    private PathChain firstPath, secondPath, thirdPath, fourthPath, fifthPath, returnPath;
        ...
        switch (autoState) {
            case DRIVE_TO_FIRST:
                ...
                if(!follower.isBusy()){
                    ...
                    autoState = RedClose1.AutoState.DRIVE_TO_SECOND;
                }
            ...
            case DRIVE_TO_SECOND:
                ...
                if (!follower.isBusy()) {
                    ...
                    autoState = RedClose1.AutoState.DRIVE_TO_THIRD;
                }
            ...
            case DRIVE_TO_THIRD:
                ...
                if(ShotCompleted) {
                    shooter.stop();
                    stateTimer.reset();
                    autoState = RedClose1.AutoState.DRIVE_TO_FIRST;
                    ShotStarted = false;
                    ShotCompleted = false;
